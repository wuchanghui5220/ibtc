...
const ndrProducts = [
    ...
    {name: '400G 光模块NDR', model: 'MMA4Z00-NS400', desc: 'NVIDIA single port transceiver, 400Gbps,NDR, OSFP, MPO12 APC, 850nm MMF,  up to 50m, flat top', qty: 0},
    {name: '1.6T 光模块XDR', model: 'NVIDIA 1.6T transceiver', desc: 'NVIDIA twin port transceiver, 1.6Tbps, Q3, OSFP, MPO12 APC, 1310nm MMF, up to 500m', qty: 0},
